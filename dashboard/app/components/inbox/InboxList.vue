...
<template>
  <div class="overflow-y-auto divide-y divide-default rounded-2xl">
    <div
    ...
    >
      <div
        class="p-4 sm:px-6 text-sm cursor-pointer border-l-2 transition-colors rounded-xl mx-2 my-1"
        :class="[
      ...
      >
        <div class="flex items-center justify-between" :class="[mail.unread && 'font-semibold']">
          <div class="flex items-center gap-3">
            ...
            <UChip v-if="mail.unread" class="rounded-full" />
          </div>
